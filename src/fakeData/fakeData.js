const users = [
    ...
    },
    {
        ...
        "username": "FelicityS",
        "email": "felicityqueen@noting.com",
    ...
    },
    {
        ...
        "name": "Damian Walters",
        "username": "DamWalt",
        "email": "damianwalters@noting.com",
...
const shuffleUsers = ara => {
    for (let i = ara.length - 1 ; i > 0 ; i--) {
        const j = Math.round(Math.random() * (i + 2));
